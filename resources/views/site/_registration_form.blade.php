@php
    ...
    $regLogoMap = [
        'ru' => ['dark' => '/images/aral_logo/dark/logo_footer_new_ru.svg', 'light' => '/images/aral_logo/light/logo_footer_new_ru.svg'],
        'uz' => ['dark' => '/images/aral_logo/dark/logo_footer_new_uz.svg', 'light' => '/images/aral_logo/light/logo_footer_new_uz.svg'],
        'kk' => ['dark' => '/images/aral_logo/dark/logo_footer_new_ka.svg', 'light' => '/images/aral_logo/light/logo_footer_new_ka.svg'],
        'en' => ['dark' => '/images/aral_logo/dark/logo_footer_new_en.svg', 'light' => '/images/aral_logo/light/logo_footer_new_en.svg'],
    ];
                ...
                <form action="{{ route('register') }}" method="post" class="modal_form">
                    ...
                    <div class="row g-3 form_inputs">
                        <div class="col-md-6">
                            ...
                            @error('first_name', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('last_name', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('email', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('phone', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            @error('address', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('city', 'registration') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-6">
                            <input type="text" name="state" value="{{ old('state') }}"
                                   class="form_input" placeholder="{{ translator('app', 'State / Province') }}">
                        </div>
                    ...
                    <div class="row checkbox_row">
                        <div class="form-group">
                            <div class="group-title">{{ translator('app', 'How did you hear about the Summit?') }}</div>
                        ...
                        <div class="form-group">
                            <div class="group-title">{{ translator('app', 'How many will attend? (multiple choice allowed)') }}</div>
                            <div class="d-flex flex-wrap checkbox_wrapper">
