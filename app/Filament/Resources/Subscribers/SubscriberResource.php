...
class SubscriberResource extends Resource
{
    ...
    public static function getModelLabel(): string { return 'Subscriber'; }
    public static function getPluralModelLabel(): string { return 'Subscribers'; }
    public static function getNavigationSort(): int { return 2; }
    public static function getNavigationBadge(): ?string { return (string) static::$model::count(); }

    public static function form(Schema $schema): Schema { return SubscriberForm::configure($schema); }
    public static function table(Table $table): Table { return SubscribersTable::configure($table); }
