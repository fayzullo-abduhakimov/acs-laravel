...
class SocialLinkResource extends Resource
{
    ...
    public static function getModelLabel(): string { return 'Social Link'; }
    public static function getPluralModelLabel(): string { return 'Social Links'; }
    public static function getNavigationSort(): int { return 3; }

    public static function form(Schema $schema): Schema { return SocialLinkForm::configure($schema); }
    public static function table(Table $table): Table { return SocialLinksTable::configure($table); }
